...
| [`BUSINESS_RULES.md`](BUSINESS_RULES.md) | In progress | Bất biến giỏ hàng C3, checkout C4, state machine C5 và tồn kho/cảnh báo C6; nghiệp vụ C7–C8 còn planned |
| [`API.md`](API.md) | In progress | Auth, shop, catalog, giỏ hàng, checkout, đơn hàng, tồn kho/cảnh báo, role và error contract; các endpoint từ C7 còn planned |

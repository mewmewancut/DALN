...
| [`BUSINESS_RULES.md`](BUSINESS_RULES.md) | In progress | Bất biến giỏ hàng C3, checkout C4 và state machine C5; nghiệp vụ C6–C8 còn planned |
| [`API.md`](API.md) | In progress | Auth, shop, catalog, giỏ hàng, checkout, đơn hàng, role và error contract; các endpoint từ C6 còn planned |

...
| [`BUSINESS_RULES.md`](BUSINESS_RULES.md) | In progress | Bất biến giỏ hàng C3, checkout C4, state machine C5, tồn kho/cảnh báo C6, supplier/nhập hàng C7, review C8 và số liệu thống kê shop C9; admin C10 còn planned |
| [`API.md`](API.md) | In progress | Auth, shop, catalog, giỏ hàng, checkout, đơn hàng, tồn kho/cảnh báo, supplier/nhập hàng, review, số liệu thống kê shop, role và error contract; các endpoint từ C10 còn planned |
